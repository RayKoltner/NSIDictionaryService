...
namespace NSIDictionaryService.Api.Controllers.Dictionaries
{
    ...
    public class V025Controller : Controller
    {
        private readonly int _dictionaryIdentifier;
        private readonly string _dictionaryIdentifierName = "V025";
        private readonly string _storagePath;
        private readonly string _outputPath;
        private readonly IV025Repository _dictRepository;
        private readonly V025Uploader _uploader;
        ...
        private readonly ILogger<V025Controller> _logger;
        private readonly UniversalXMLDocCreator _xmlCreator;

        public V025Controller(
            IV025Repository dictRepository,
            ...
            ILogger<V025Controller> logger,
            ILogger<V025Uploader> uploadLogger)
        {
            _uploader = new V025Uploader(propertyRepository, dictRepository, uploadLogger, changeRepository);
            ...
            if (name == null) throw new Exception("Нет записи о справочнике V025 в таблице названий справочников");
        ...
        public IActionResult GetAll()
        {
            ...
            List<V025ResponseDTO> dtos = new List<V025ResponseDTO>();
            foreach (var item in result) dtos.Add(new V025ResponseDTO(item));
            return Ok(dtos);
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return Ok(new V025ResponseDTO(result));
        }
        ...
        [HttpPost("addEntry")]
        public async Task<IActionResult> PostAsync([FromBody] V025DTO value)
        {
            ...
            V025Dictionary posted = V025DTOtoEntityMapper.Convert(value);
        ...
        [HttpPut("changeEntry")]
        public async Task<IActionResult> Put([FromBody] V025PutDTO value)
        {
            try
            {
        ...
        public async Task<IActionResult> UploadFromApi()
        {
            ...
            try
            {
                ...
                if (!result)
                {
                    ...
                    _logger.LogError("Ошибка при заполнении словаря V025 из API");
                ...
                _logger.LogInformation("Успешно загружен словарь V025 из API");
                return Ok();
            }
            catch (InvalidVersionException ex)
            {
                ...
                _logger.LogError($"Ошибка при загрузке словаря V025 из API: {ex.Message}");
        ...
        public async Task<IActionResult> UploadFromXML(IFormFile formFile)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("Успешно загружен словарь V025 из XML-файла");
                return Ok();
            }
            catch (InvalidVersionException ex)
            {
